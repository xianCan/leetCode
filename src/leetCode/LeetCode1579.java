...
public class LeetCode1579 {
    ...
    public int maxNumEdgesToRemove(int n, int[][] edges) {
        ...
        for (int[] edge : edges){
            if (edge[0] == 3){
                ...
                bobUnionFind.union(edge[1], edge[2]);
            }
        }
        ...
        if (aliceUnionFind.getCount() != 1 || bobUnionFind.getCount() != 1){
            return -1;
        }
    ...
    public static void main(String[] args) {
        ...
        int i = new LeetCode1579().maxNumEdgesToRemove(4, new int[][]{{3, 2, 3}, {1, 1, 2}, {2, 3, 4}});
